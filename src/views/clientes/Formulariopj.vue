<template>
  <section class="clientes">
    <div>
      <span class="title">Cadastro de Pessoa Jurídica</span>
  ...
  methods: {
    ...
    validaCampo() {
      while (
        ...
        !this.currentCliente.ramoAtividade
      ) {
        return;
      }
      this.removeHidden(".endereco");
    },
    buscaEndereco(endereco: ICliente) {
      ...
      while (!this.currentCliente.estado) {
        return;
      }
      this.removeHidden(".contato");
    },
    buscaContato(contato: ICliente) {
      ...
      while (!this.currentCliente.emailContato) {
        return;
      }
      console.log(this.currentCliente);

      this.removeHidden(".hidden");
      this.removeHidden(".hidden");
    },
    removeHidden(item: string) {
      return document.querySelector(item)?.classList.remove("hidden");
    },
  },
  setup() {
